...
export function Motion() {
  return (
    <section id="omnisense-motion" className="w-full bg-home-ink-900 py-[100px]">
      <Container>
        <div className="flex flex-col items-center">
          ...
          <h2 className="mt-[24px] text-center font-serif text-[44px] font-normal leading-[52px] text-[#f7f7f7]">
