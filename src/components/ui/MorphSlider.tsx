...
void main() {
  ...
  vec3 bg = vec3(0.047, 0.047, 0.055);
...
class MorphEngine {
  ...
  constructor(container: HTMLDivElement, { items, startIndex, reducedMotion, getOptions, onIndexChange, dprCap }: MorphEngineConfig) {
...
export default function MorphSlider({
  ...
  const optsRef = useRef<MorphSliderOptions>({ transition, duration, ease, intensity, scale, aberration, drift, overlayColor, loop })
